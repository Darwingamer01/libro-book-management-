...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                if (bookRepository.count() == 0) {
                        createBook("The Alchemist", "Paulo Coelho", "A magical tale about following your dreams.",
                                        "Fiction",
                                        "978-0062315007", 1988, "HarperOne", 208, "English", true, 120);

                        createBook("Clean Code", "Robert C. Martin", "A Handbook of Agile Software Craftsmanship.",
                                        "Technology",
